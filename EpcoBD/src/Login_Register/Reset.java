...
public class Reset extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String sql2 = "select * from users where Answer=?";
           ...
           sql1="select * from reset_password where Username=? and Password=?";
           ...
           if(rs1.next()){
            ...
            sql1="INSERT INTO `reset_password` (`Username`,`Password`) VALUES (?,?)";   
            pst1=JConn.getConnection().prepareStatement(sql1);
            pst1.setString(1,username);
            pst1.setString(2,pass);
            pst1.executeUpdate();
