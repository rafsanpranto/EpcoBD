...
public class Sign_Up extends javax.swing.JFrame {
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(label5, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton_signupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_signupActionPerformed
        ...
        if(verifyFields())
        {
            if(!checkUsername(username))
            {
                ...
                ResultSet rs;
                String registerUserQuery = "INSERT INTO `users`(`full_name`, `username`, `email`, `password`, `phone number`, `Security Question`, `Answer`) VALUES (?,?,?,?,?,?,?)";
                ...
                try {
                    ...
                    registerUserQuery = "INSERT INTO `reset_password`(`Username`, `Password`) VALUES (?,?)";
                    ps = JConn.getConnection().prepareStatement(registerUserQuery);
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        Sign_Up_Admin rf = new Sign_Up_Admin();
        rf.setVisible(true);
        rf.pack();
        rf.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
